...
.method public static asInterface(Landroid/os/IHwBinder;)Landroid/hardware/radio/V1_1/IRadioIndication;
    ...
    .line 24
    check-cast v2, Landroid/hardware/radio/V1_1/IRadioIndication;

    return-object v2

    .line 27
    :cond_1
    new-instance v2, Landroid/hardware/radio/V1_1/IRadioIndication$Proxy;

    invoke-direct {v2, p0}, Landroid/hardware/radio/V1_1/IRadioIndication$Proxy;-><init>(Landroid/os/IHwBinder;)V

    .line 30
    :try_start_0
    invoke-interface {v2}, Landroid/hardware/radio/V1_1/IRadioIndication;->interfaceChain()Ljava/util/ArrayList;
...
.method public static castFrom(Landroid/os/IHwInterface;)Landroid/hardware/radio/V1_1/IRadioIndication;
    ...
    invoke-static {p0}, Landroid/hardware/radio/V1_1/IRadioIndication;->asInterface(Landroid/os/IHwBinder;)Landroid/hardware/radio/V1_1/IRadioIndication;
